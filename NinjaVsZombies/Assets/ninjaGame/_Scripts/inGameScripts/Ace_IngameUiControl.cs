...
public class Ace_IngameUiControl : MonoBehaviour
{
	...
	public Text  scoreCountText, coinsCountText;//for ingameui texts
	...
	{
		Static = this;
		distanceCountText.text = "" + inGameDistance + " 米";
	...
	void Distance_IngameCount ()
	{
		...
		distanceCountText.text = "" + inGameDistance + " 米";// for display the distance
	}

...
public class Playerselection : MonoBehaviour
{
		...
		public TMP_Text PlayerNameText, PlayerPriceDisplayText, headingText;
		...
		void showPlayerINFO ()
		{
				...
				case 0:
						headingText.text = "选择角色 ";
						PlayerNameText.text = "地球忍者";
						PlayerPriceDisplayText.text = "免费";
